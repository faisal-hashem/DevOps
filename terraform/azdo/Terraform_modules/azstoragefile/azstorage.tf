  ...
  min_tls_version          = "TLS1_2"
      ...
      azure_files_authentication {
        ...
        active_directory  {
                            ...
                            netbios_domain_name = "GAP" 
                            forest_name = "gapartners.com"
