...
$NewData = ".\DOMAIN$CurrentDate.CSV"
$YesterdaysDatafile = ".\DOMAIN$YesterdayDate.CSV"
...
@{Name = "managerEmail"; Expression = { ($_.manager) + '@DOMAIN.com' } }, `
...
$YesterdaysData = import-csv ".\DOMAIN$YesterdayDate.CSV" -Header $header | where { $_.language -ne "Deactivated" } | Select Employeeid, password, firstname, middlename, lastname, email, jobfamily, department, hiredate, title, location, managerID, managerName, managerEmail, workertype
