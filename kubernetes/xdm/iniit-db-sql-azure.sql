...
ALTER DATABASE semarchy_repository SET READ_COMMITTED_SNAPSHOT ON;
GO

ALTER DATABASE semarchy_repository SET QUOTED_IDENTIFIER ON;
GO

/* Create a login to connect the database  - DEFAULT_DATABASE not supported */

CREATE LOGIN _db_administrator WITH PASSWORD='password', DEFAULT_DATABASE=semarchy_repository
GO
...
CREATE LOGIN _db_administrator_ro WITH PASSWORD='password', DEFAULT_DATABASE=semarchy_repository
GO
